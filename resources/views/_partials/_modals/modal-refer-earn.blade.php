    ...
    <div class="modal-content">
      <div class="modal-body pt-4 pt-md-0 px-0 pb-md-0">
        ...
        <div class="text-center mb-6">
          ...
          <p class="text-center mb-6">Invite your friend to {{ config('variables.templateName') }}, if they sign up, you
            and your friend
            will get 30 days free trial.</p>
        </div>
        <div class="row py-6">
        ...
        <form class="row g-4" onsubmit="return false">
          <div class="col-lg-10">
            <label class="mb-2" for="modalRnFEmail">Enter your friend’s email address and invite them to join
              {{ config('variables.templateName') }} 😍</label>
            <input type="text" id="modalRnFEmail" class="form-control form-control-sm"
        ...
        <form class="row g-4" onsubmit="return false">
          <div class="col-lg-9">
            <label class="mb-2" for="modalRnFLink">You can also copy and send it or share it on your social media.
              🥳</label>
            <div class="input-group input-group-sm input-group-merge">
              <input type="text" id="modalRnFLink" class="form-control"
                value="{{ config('variables.creatorUrl') }}" />
              <span class="input-group-text text-primary cursor-pointer text-uppercase" id="basic-addon33">Copy
                link</span>
            </div>
          </div>
          <div class="col-lg-3 d-flex align-items-end">
            <div class="btn-social">
              <button type="button" class="btn btn-icon btn-facebook"><i
                  class="icon-base ri ri-facebook-circle-line icon-22px"></i></button>
              <button type="button" class="btn btn-icon btn-twitter"><i
                  class="icon-base ri ri-twitter-line icon-22px"></i></button>
              <button type="button" class="btn btn-icon btn-linkedin"><i
                  class="icon-base ri ri-linkedin-line icon-22px"></i></button>
            </div>
          </div>
        </form>
      </div>

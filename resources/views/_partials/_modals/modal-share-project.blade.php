    ...
    <div class="modal-content">
      ...
      <div class="mb-6">
        <div class="form-floating form-floating-outline">
          <select id="select2Basic" class="select2 form-select share-project-select" data-allow-clear="true">
            <option data-name="Adelaide Nichols" data-image="img/avatars/20.png" selected="selected">Adelaide Nichols
            </option>
      ...
      <div class="d-flex align-items-center flex-wrap mt-6">
        ...
        <div class="d-flex justify-content-between flex-grow-1 align-items-center flex-wrap gap-3">
          ...
          <button class="btn btn-primary"><i class="icon-base ri ri-link-m me-1_5"></i>Copy Project Link</button>
        </div>
      </div>
    </div>
  </div>

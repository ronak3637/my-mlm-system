                  ...
                  <div class="flex-grow-1">
                    <div class="row text-center text-sm-start">
                      <div class="col-md-8">
                        ...
                        <div class="read-only-ratings raty mb-2 px-0" data-rateyo-read-only="true" data-score="4"
                          data-number="5"></div>
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <button type="button" class="btn text-body-secondary p-0 shadow-none btn-pinned"
                            aria-label="Close">
      ...
      <div id="checkout-address" class="content">
        <div class="row">
          ...
          <div class="col-xl-8 mb-4 mb-xl-0">
              ...
              <div class="col-md">
                <div class="form-check custom-option custom-option-basic">
                  <label class="form-check-label custom-option-content" for="customRadioAddress2">
                    ...
                    <span class="custom-option-body">
                      <small class="d-xxl-block pe-xxl-12 me-xxl-12">8723 Schoffman Avenue, New York, NY,
                        10016.<br />Mobile : 1234567890 Cash / Card on delivery available</small>
                      <span class="my-2 border-bottom d-block"></span>
                      <span class="d-flex">
                        <a class="me-4" href="javascript:void(0)">Edit</a>
                        <a href="javascript:void(0)">Remove</a>
            ...
            <button type="button" class="btn btn-sm btn-outline-primary mb-6" data-bs-toggle="modal"
                ...
                <div class="tab-pane fade show active" id="pills-cc" role="tabpanel"
                  ...
                  <div class="row g-5">
                    ...
                    <div class="col-12 col-md-6">
                      <div class="form-floating form-floating-outline">
                        <input id="paymentCardName" name="paymentCardName" class="form-control" type="text"
                    ...
                    <div class="col-6 col-md-3">
                      <div class="form-floating form-floating-outline">
                        <input id="paymentCardExpiryDate" name="paymentCardExpiryDate"
                          class="form-control expiry-date-mask" type="text" placeholder="MM/YY" />
                    ...
                    <div class="col-6 col-md-3">
                      <div class="input-group input-group-merge">
                        ...
                        <span class="input-group-text cursor-pointer" id="paymentCardCvv2">
                          <i class="icon-base ri ri-question-line" data-bs-toggle="tooltip" data-bs-placement="top"
                ...
                <div class="d-flex gap-4">
                  ...
                  <div class="flex-grow-1">
                    <div class="row d-flex align-items-center">
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <div class="my-2 my-lg-6"><span class="text-primary">$299/</span><span
                              class="text-body-secondary">$359</span></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="d-flex gap-4">
                  ...
                  <div class="flex-grow-1">
                    <div class="row d-flex align-items-center">
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <div class="my-2 my-lg-6"><span class="text-primary">$899/</span><span
                              class="text-body-secondary">$999</span></div>
                        </div>
                      </div>
                    </div>
                  </div>

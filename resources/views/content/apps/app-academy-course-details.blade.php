            ...
            <div class="card academy-content shadow-none border">
              ...
              <div class="card-body pt-3">
                ...
                <div class="d-flex flex-wrap row-gap-2">
                  <div class="me-12">
                    <p class="text-nowrap mb-2"><i class="icon-base ri ri-check-line icon-20px me-2"></i>Skill level: All
                      Levels</p>
                    <p class="text-nowrap mb-2"><i class="icon-base ri ri-group-line icon-20px me-2"></i>Students: 38,815
                    </p>
                    <p class="text-nowrap mb-2"><i class="icon-base ri ri-global-line icon-20px me-2"></i>Languages:
                      English</p>
                    <p class="text-nowrap mb-0"><i class="icon-base ri ri-pages-line icon-20px me-2"></i>Captions: Yes</p>
                  </div>
                  <div>
                    <p class="text-nowrap mb-2"><i
                        class="icon-base ri ri-video-upload-line icon-20px me-2 ms-50"></i>Lectures: 19</p>
                    <p class="text-nowrap"><i class="icon-base ri ri-time-line icon-20px me-2"></i>Video: 1.5 total hours
                    </p>
                  </div>
                </div>
                <hr class="my-6" />
                ...
                <p class="mb-6">The material of this course is also covered in my other course about web design and
                  development with HTML5 & CSS3. Scroll to the bottom of this page to check out that course, too! If
                  you're already taking my other course, you already have all it takes to start designing beautiful
                  websites today!</p>
                ...
                <p>"Very helpful to us left-brained people: I am familiar with HTML, CSS, JQuery, and Twitter Bootstrap,
                  but I needed instruction in web design. This course gave me practical, impactful techniques for making
                  websites more beautiful and engaging." — Susan Darlene Cain</p>
                <hr class="my-6" />
                <h5>Instructor</h5>
                <div class="d-flex justify-content-start align-items-center user-name">
                  <div class="avatar-wrapper">
                    <div class="avatar me-4"><img src="{{ asset('assets/img/avatars/1.png') }}" alt="Avatar"

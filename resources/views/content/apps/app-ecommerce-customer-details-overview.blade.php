      ...
      <div class="card-body pt-12">
        ...
        <div class="d-flex justify-content-around flex-wrap mb-6 gap-4 gap-md-3 gap-lg-4">
          <div class="d-flex align-items-center gap-4 me-5">
            <div class="avatar">
              <div class="avatar-initial rounded-3 bg-label-primary"><i
    ...
    <div class="card bg-primary">
      <div class="card-body">
        <div class="row justify-content-between mb-4">
          ...
          <span
            class="col-md-12 col-lg-5 col-xl-12 col-xxl-5 text-center text-lg-end text-xl-center text-xxl-end mx-auto mx-md-0 mb-2"><img
      ...
      <ul class="nav nav-pills flex-column flex-md-row mb-6 row-gap-2 flex-wrap">
        <li class="nav-item">
          <a class="nav-link active" href="javascript:void(0);"><i
              class="icon-base ri ri-group-line icon-sm me-2"></i>Overview</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('app/ecommerce/customer/details/billing')}}"><i
              class="icon-base ri ri-map-pin-line icon-sm me-2"></i>Address & Billing</a>
        </li>
        <li class="nav-item">
      ...
      <div class="col-md-6 mb-6">
        <div class="card">
          <div class="card-body">
            <div class="card-icon mb-2">
              <div class="avatar">
                <div class="avatar-initial rounded-3 bg-label-warning"><i
      ...
      <div class="col-md-6 mb-6">
        <div class="card">
          <div class="card-body">
            <div class="card-icon mb-2">
              <div class="avatar">
                <div class="avatar-initial rounded-3 bg-label-info"><i

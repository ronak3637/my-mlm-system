              ...
              <div data-repeater-item>
                <div class="row gx-5">
                  <div class="mb-6 col-sm-4">
                    <div class="form-floating form-floating-outline">
                      <select id="select2Basic" class="form-select form-select-sm" data-placeholder="Option"
              ...
              <div class="tab-content p-0 pe-xl-0 ps-md-4">
                  ...
                  <div class="row mb-4 g-4">
                    ...
                    <div class="col-6 col-sm-4 col-lg-6 col-xxl-4">
                      <button class="btn btn-primary"><i
                          class="icon-base ri ri-check-line icon-16px me-2"></i>Confirm</button>
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    <div class="form-check mb-4">
                      ...
                      <label class="form-check-label d-flex flex-column gap-1" for="seller">
                        ...
                        <small>You'll be responsible for product delivery. Any damage or delay during shipping may cost
                    ...
                    <div class="form-check mb-6">
                      ...
                      <label class="form-check-label d-flex flex-column gap-1" for="companyName">
                        ...
                        <small>Your product, Our responsibility. For a measly fee, we will handle the delivery process
                          for you.</small>
                      </label>
                    </div>
                ...
                <div class="tab-pane fade" id="global-delivery" role="tabpanel">
                  ...
                  <div class="form-check mb-4">
                    ...
                    <div class="form-floating form-floating-outline">
                      <input type="text" class="form-control form-control-sm" placeholder="Type Country name"
                        id="country-selected" />
                ...
                <div class="tab-pane fade" id="attributes" role="tabpanel">
                  ...
                  <div>
                    ...
                    <div class="form-check mb-4">
                      ...
                      <div class="form-floating form-floating-outline">
                        <input type="number" class="form-control form-control-sm" placeholder="In Celsius" id="temp" />

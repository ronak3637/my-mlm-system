          ...
          <div class="mb-6">
            ...
            <div class="row gx-4 gy-2">
              <div class="col-sm-9 col-lg-8">
                <input type="text" id="referralEmail" name="referralEmail" class="form-control form-control-sm"
                  placeholder="Enter friend’s email address" />
              </div>
              <div class="col-sm-3 col-lg-4">
                <button type="submit" class="btn btn-primary"><i
                    class="icon-base ri ri-check-line icon-16px me-2"></i>Submit</button>
              </div>
            </div>
          </div>
          <div class="pt-4">
            ...
            <div class="row gx-4 gy-2">
              <div class="col-sm-9 col-lg-8">
                <input type="text" id="referralLink" name="referralLink" class="form-control form-control-sm"
                  placeholder="pixinvent.com/?ref=6479" />
              </div>
              <div class="col-sm-3 col-lg-4">
                <div class="d-flex gap-2">
                  <button type="button" class="btn btn-facebook btn-icon"><i
                      class="icon-base ri ri-facebook-circle-line text-white icon-22px"></i></button>
                  <button type="button" class="btn btn-twitter btn-icon"><i
                      class="icon-base ri ri-twitter-line text-white icon-22px"></i></button>
                </div>
              </div>
            </div>
          </div>

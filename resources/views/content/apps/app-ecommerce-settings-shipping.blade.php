        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <div>
                <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-text-secondary rounded-pill me-1"><i
                    class="icon-base ri ri-pencil-line icon-20px"></i></a>
                <a href="javascript:void(0);" class="btn btn-sm btn-icon btn-text-secondary rounded-pill"><i
                    class="icon-base ri ri-delete-bin-7-line icon-20px"></i></a>
              </div>
            </div>
                      ...
                      <td class="text-end">
                        <div class="dropdown pe-4">
                          <button type="button" class="btn  btn-sm btn-icon btn-text-secondary rounded-pill"
                            data-bs-toggle="dropdown"><i class="icon-base ri ri-more-2-line icon-22px"></i></button>

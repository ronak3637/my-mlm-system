            ...
            <div class="repeater-wrapper pt-0 pt-md-9" data-repeater-item>
              <div class="d-flex border rounded position-relative pe-0">
                ...
                <div class="d-flex flex-column align-items-center justify-content-between border-start p-2">
                  ...
                  <div class="dropdown">
                    <i class="icon-base ri ri-settings-3-line cursor-pointer more-options-dropdown" role="button"
          ...
          <div class="row">
            <div class="col-12">
              <button type="button" class="btn btn-primary btn-sm" data-repeater-create><i
                  class="icon-base ri ri-add-line icon-14px me-1_5"></i>Add Item</button>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="card-body">
        <button class="btn btn-primary d-grid w-100 mb-4" data-bs-toggle="offcanvas"
          ...
          <span class="d-flex align-items-center justify-content-center text-nowrap"><i
              class="icon-base ri ri-send-plane-line icon-16px scaleX-n1-rtl me-2"></i>Send Invoice</span>
        </button>

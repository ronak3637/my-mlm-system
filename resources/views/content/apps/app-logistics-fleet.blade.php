...
<div class="card overflow-hidden">
  ...
  <div class="d-flex app-logistics-fleet-wrapper">
    ...
    <div class="flex-shrink-0 position-fixed m-6 d-md-none w-auto z-1">
      <button class="btn btn-white btn-white-dark-variant z-2 p-2" data-bs-toggle="sidebar" data-overlay=""
        data-target="#app-logistics-fleet-sidebar"><i class="icon-base ri ri-menu-line icon-24px"></i></button>
    </div>
    ...
    <div class="app-logistics-fleet-sidebar col h-100 rounded-0" id="app-logistics-fleet-sidebar">
      <div class="card-header border-0 pb-2 d-flex justify-content-between">
        ...
        <i class="icon-base ri ri-close-line icon-24px cursor-pointer close-sidebar d-md-none" data-bs-toggle="sidebar"
      ...
      <div class="card-body p-0 logistics-fleet-sidebar-body">
        <!-- Menu Accordion -->
        <div class="accordion p-5 ps-0 pt-0" id="fleet" data-bs-toggle="sidebar" data-overlay
          ...
          <div class="accordion-item shadow-none border-0 active my-0" id="fl-1">
            <div class="accordion-header border-0" id="fleetOne">
              <div role="button" class="accordion-button pe-0 shadow-none" data-bs-toggle="collapse"
          ...
          <div class="accordion-item shadow-none border-0 my-0" id="fl-2">
            <div class="accordion-header border-0" id="fleetTwo">
              <div role="button" class="accordion-button pe-0 collapsed shadow-none" data-bs-toggle="collapse"
                data-bs-target="#fleet2" aria-expanded="true" aria-controls="fleet2">
                <div class="d-flex align-items-center">
                  <div class="avatar-wrapper">
                    <div class="avatar me-4">
                      <span class="avatar-initial rounded-circle bg-label-secondary"><i
          ...
          <div class="accordion-item shadow-none border-0 my-0" id="fl-3">
            <div class="accordion-header border-0" id="fleetThree">
              <div role="button" class="accordion-button pe-0 collapsed shadow-none" data-bs-toggle="collapse"
                data-bs-target="#fleet3" aria-expanded="true" aria-controls="fleet3">
                <div class="d-flex align-items-center">
                  <div class="avatar-wrapper">
                    <div class="avatar me-4">
                      <span class="avatar-initial rounded-circle bg-label-secondary"><i
          ...
          <div class="accordion-item shadow-none border-0 my-0" id="fl-4">
            <div class="accordion-header border-0" id="fleetFour">
              <div role="button" class="accordion-button pe-0 collapsed shadow-none" data-bs-toggle="collapse"
                data-bs-target="#fleet4" aria-expanded="true" aria-controls="fleet4">
                <div class="d-flex align-items-center">
                  <div class="avatar-wrapper">
                    <div class="avatar me-4">
                      <span class="avatar-initial rounded-circle bg-label-secondary"><i
            ...
            <div id="fleet4" class="accordion-collapse collapse" data-bs-parent="#fleet">
              <div class="accordion-body pt-5 pb-0">
                ...
                <div class="progress bg-label-primary rounded-pill" style="height: 5px;">
                  <div class="progress-bar" role="progressbar" style="width: 28%;" aria-valuenow="28" aria-valuemin="0"
                    aria-valuemax="100"></div>
                </div>
                <ul class="timeline mb-3 ps-4 mt-8">
                  <li class="timeline-item ps-6 border-dashed">

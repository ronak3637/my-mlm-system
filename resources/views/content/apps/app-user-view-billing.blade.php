    ...
    <div class="card mb-6 border border-2 border-primary">
      <div class="card-body">
        ...
        <ul class="list-unstyled g-2 my-6">
          ...
          <li class="mb-2 d-flex align-items-center"><i
              class="icon-base ri ri-circle-fill icon-10px text-body me-2"></i><span>Up to 10 GB storage</span></li>
          <li class="mb-2 d-flex align-items-center"><i
              class="icon-base ri ri-circle-fill icon-10px text-body me-2"></i><span>Basic Support</span></li>
        </ul>
        ...
        <div class="progress mb-1 bg-label-primary rounded" style="height: 6px;">
          <div class="progress-bar rounded" role="progressbar" style="width: 75%;" aria-valuenow="75" aria-valuemin="0"
  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
      ...
      <div class="card-body">
        <div class="row row-gap-4">
          ...
          <div class="col-xl-6 order-0 order-xl-0">
            <div class="alert alert-warning mb-4 alert-dismissible" role="alert">
              <h5 class="alert-heading mb-1 d-flex align-items-center">
                <span class="alert-icon rounded-3"><i class="icon-base ri ri-alert-line icon-22px"></i></span>
            ...
            <div class="plan-statistics">
              ...
              <div class="progress bg-label-primary mb-1 rounded">
                <div class="progress-bar rounded" style="width: 20%;" role="progressbar" aria-valuenow="20"
          ...
          <div class="col-12 order-2 order-xl-0 d-flex flex-wrap gap-4">
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#upgradePlanModal">Upgrade
              Plan</button>
    ...
    <div class="card card-action mb-6">
      <div class="card-header align-items-center">
        ...
        <div class="card-action-element">
          <button class="btn btn-sm btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#addNewCCModal"><i
              class="icon-base ri ri-add-line icon-14px me-1"></i>Add Card</button>
        </div>
      </div>
      <div class="card-body">
        <div class="added-cards">
          <div class="cardMaster border p-5 rounded-4 mb-4">
            <div class="d-flex justify-content-between flex-sm-row flex-column">
              <div class="card-information">
                <img class="mb-2 img-fluid" src="{{asset('assets/img/icons/payments/mastercard.png')}}"
                  alt="Master Card" />
              ...
              <div class="d-flex flex-column text-start text-lg-end">
                <div class="d-flex order-sm-0 order-1 mt-sm-2">
                  <button class="btn btn-sm btn-outline-primary me-4" data-bs-toggle="modal"
          ...
          <div class="cardMaster border p-5 rounded-4">
            <div class="d-flex justify-content-between flex-sm-row flex-column">
              <div class="card-information">
                <img class="mb-2 img-fluid" src="{{asset('assets/img/icons/payments/american-express-logo.png')}}"
                  alt="Visa Card" />
                <div class="d-flex align-items-center mb-2">
    ...
    <div class="card card-action mb-6">
      <div class="card-header align-items-center">
        ...
        <div class="card-action-element">
          <button class="btn btn-sm btn-primary edit-address" type="button" data-bs-toggle="modal"
            data-bs-target="#addNewAddress"><i class="icon-base ri ri-add-line icon-14px me-1"></i>Edit address</button>
        </div>
      </div>
      <div class="card-body">
        <div class="row">

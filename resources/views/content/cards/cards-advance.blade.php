    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        ...
        <form id="paymentDetailsForm" onsubmit="return false">
          ...
          <a href="javascript:;" class="d-block mb-3 small" data-bs-toggle="modal" data-bs-target="#addNewCCModal"> Add
            Payment Method </a>
  ...
  <div class="col-md-6 col-xxl-4">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-body-secondary p-0" type="button" id="projectStatus" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
            <i class="icon-base ri ri-more-2-line"></i>
          </button>
  ...
  <div class="col-xxl-8">
    <div class="card">
      <div class="card-header d-flex justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-body-secondary p-0" type="button" id="earningReportsTabsId" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
            <i class="icon-base ri ri-more-2-line"></i>
          </button>
      ...
      <div class="card-body">
        ...
        <div class="mb-6 pb-1">
          ...
          <div class="progress w-100 rounded bg-label-primary" style="height: 6px;">
            <div class="progress-bar bg-primary" style="width: 75%" role="progressbar" aria-valuenow="85"
        ...
        <div class="mb-6 pb-1">
          ...
          <div class="progress w-100 rounded bg-label-success" style="height: 6px;">
            <div class="progress-bar bg-success" style="width: 55%" role="progressbar" aria-valuenow="55"
              aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
        <div>
          ...
          <div class="progress w-100 rounded bg-label-danger" style="height: 6px;">
            <div class="progress-bar bg-danger" style="width: 35%" role="progressbar" aria-valuenow="35"
              aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
      </div>
  ...
  <div class="col-md-6 col-xxl-4">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-body-secondary p-0" type="button" id="socialNetworkList" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
            <i class="icon-base ri ri-more-2-line "></i>
          </button>
          ...
          <li class="d-flex align-items-center mb-4">
            <div class="flex-shrink-0">
              <img src="{{asset('assets/img/icons/brands/twitter-'.$configData['theme'].'.png') }}" alt="twitter"
                class="me-3" height="34" data-app-dark-img="icons/brands/twitter-dark.png"
  ...
  <div class="col-md-6 col-xxl-4 order-0 order-sm-3 order-xxl-0">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-body-secondary p-0" type="button" id="generalStatistics" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
            <i class="icon-base ri ri-more-2-line"></i>
          </button>
      ...
      <div class="card-body pb-4">
        ...
        <div class="mb-5">
          ...
          <div class="progress w-100 rounded bg-label-primary" style="height: 6px;">
            <div class="progress-bar bg-primary" style="width: 24%" role="progressbar" aria-valuenow="85"
              aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
        <div class="table-responsive text-nowrap">
  ...
  <div class="col-md-6 col-xxl-4">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-secondary p-0" type="button" id="mostSales" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
            <i class="icon-base ri ri-more-2-line"></i>
          </button>
  ...
  <div class="col-md-6 col-xxl-4">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-secondary p-0" type="button" id="paymentHistory" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
            <i class="icon-base ri ri-more-2-line"></i>
          </button>
          ...
          <tbody>
            <tr>
              <td class="d-flex align-items-center pt-5">
                <div class="rounded-3 bg-light-gray d-flex h-px-30">
                  <img src="{{asset('assets/img/icons/payments/visa-'.$configData['theme'].'.png') }}" width="46"
                    alt="visa-card" data-app-light-img="icons/payments/visa-light.png"
            ...
            <tr>
              <td class="d-flex align-items-center">
                <div class="rounded-3 bg-light-gray d-flex h-px-30">
                  <img src="{{asset('assets/img/icons/payments/master-'.$configData['theme'].'.png') }}" width="46"
                    alt="master-card" data-app-light-img="icons/payments/master-light.png"
            ...
            <tr>
              <td class="d-flex align-items-center">
                <div class="rounded-3 bg-light-gray d-flex h-px-30">
                  <img src="{{asset('assets/img/icons/payments/ae-'.$configData['theme'].'.png') }}" width="46"
                    alt="american-express-card" data-app-light-img="icons/payments/ae-light.png"
  ...
  <div class="col-md-6 col-xxl-4">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-secondary p-0" type="button" id="subscribers" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
            <i class="icon-base ri ri-more-2-line"></i>
          </button>
      ...
      <div class="card-body">
        <ul class="list-unstyled mb-0">
          <li class="d-flex mb-6">
            <div class="avatar flex-shrink-0 me-4">
              <span class="avatar-initial rounded-3 bg-label-primary"><i
                  class="icon-base ri ri-video-download-line icon-24px"></i></span>
            </div>
          ...
          <li class="d-flex mb-6">
            <div class="avatar flex-shrink-0 me-4">
              <span class="avatar-initial rounded-3 bg-label-success"><i
                  class="icon-base ri ri-image-2-line icon-24px"></i></span>
            </div>
            <div class="d-sm-flex w-100 align-items-center">
              <div class="w-100 mb-2 mb-sm-0 me-sm-4">
          ...
          <li class="d-flex">
            <div class="avatar flex-shrink-0 me-4">
              <span class="avatar-initial rounded-3 bg-label-danger"><i
                  class="icon-base ri ri-music-2-line icon-24px"></i></span>
            </div>
            <div class="d-sm-flex w-100 align-items-center">
              <div class="w-100 mb-2 mb-sm-0 me-sm-4">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between mb-4">
          ...
          <div class="dropdown">
            <button class="btn text-body-secondary p-0" type="button" id="financeApp" data-bs-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">
              <i class="icon-base ri ri-more-2-line"></i>
            </button>
        ...
        <p class="my-4 small">Managing your money isn’t the easiest thing to do. Now that many of us no longer balance a
          checkbook, tracking and expenses.</p>
        <div class="mb-4">
          ...
          <div class="progress w-100 rounded bg-label-success" style="height: 8px;">
            <div class="progress-bar bg-success" style="width: 35%" role="progressbar" aria-valuenow="68"
              aria-valuemin="0" aria-valuemax="100"></div>
          </div>
        </div>
        <div class="d-flex justify-content-between align-items-center">
  ...
  <div class="col-md-6 col-xxl-4">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn text-body-secondary p-0" type="button" id="totalEarning" data-bs-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
            <i class="icon-base ri ri-more-2-line"></i>
          </button>
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div>
                ...
                <div class="progress bg-label-danger" style="height: 4px;">
                  <div class="progress-bar bg-danger" style="width: 75%" role="progressbar" aria-valuenow="75"
                    aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
            </div>
          ...
          <div class="table-responsive text-nowrap">
            <table class="table border-top">
              ...
              <tbody class="table-border-bottom-0">
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/samsung-s22.png')}}" alt="Mobile" width="34" height="34"
                      class="rounded" />
                  </td>
                  <td>Samsung s22</td>
                  <td class="text-end">
                ...
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/apple-iPhone-13-pro.png')}}" alt="Mobile" width="34"
                ...
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/oneplus-9-pro.png')}}" alt="Mobile" width="34" height="34"
                      class="rounded" />
                  </td>
                  <td>Oneplus 9 Pro</td>
                  <td class="text-end">
                ...
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/google-pixel-6.png')}}" alt="Mobile" width="34" height="34"
                      class="rounded" />
                  </td>
          ...
          <div class="table-responsive text-nowrap">
            <table class="table border-top">
              ...
              <tbody class="table-border-bottom-0">
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/apple-mac-mini.png')}}" alt="Mobile" width="34" height="34"
                      class="rounded" />
                  </td>
                ...
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/hp-envy-x360.png')}}" alt="Mobile" width="34" height="34"
                      class="rounded" />
                  </td>
                ...
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/dell-inspiron-3000.png')}}" alt="Mobile" width="34"
                      height="34" class="rounded" />
                  </td>
                ...
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/apple-iMac-4k.png')}}" alt="Mobile" width="34" height="34"
                      class="rounded" />
                  </td>
                  <td>Apple iMac 4k</td>
                  <td class="text-end">
          ...
          <div class="table-responsive text-nowrap">
            <table class="table border-top">
              ...
              <tbody class="table-border-bottom-0">
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/sony-play-station-5.png')}}" alt="Mobile" width="34"
                      height="34" class="rounded" />
                  </td>
                ...
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/xbox-series-x.png')}}" alt="Mobile" width="34" height="34"
                      class="rounded" />
                  </td>
                  <td>XBOX Series X</td>
                  <td class="text-end">
                ...
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/nintendo-switch.png')}}" alt="Mobile" width="34" height="34"
                      class="rounded" />
                  </td>
                ...
                <tr>
                  <td>
                    <img src="{{asset('assets/img/products/sup-game-box-400.png')}}" alt="Mobile" width="34" height="34"
                      class="rounded" />
                  </td>

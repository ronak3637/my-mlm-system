...
<div class="row g-6">
    ...
    <div class="card">
      <div class="d-flex align-items-end row">
        ...
        <div class="col-md-6 text-center text-md-end">
          <div class="card-body pb-0 px-0 pt-1_5">
            <img src="{{asset('assets/img/illustrations/illustration-daisy-'.$configData['theme'].'.png')}}"
              height="186" alt="View Profile" data-app-light-img="illustrations/illustration-daisy-light.png"
  ...
  <div class="col-lg-4">
    <div class="card h-100">
      ...
      <img src="{{asset('assets/img/illustrations/illustration-upgrade-account.png')}}"
        class="scaleX-n1-rtl position-absolute bottom-0 end-0 me-4 mb-4" height="162" alt="Upgrade Account" />
    </div>
  </div>
</div>
@endsection
        ...
        <div class="card-body demo-vertical-spacing demo-only-element">
          ...
          <div class="form-password-toggle">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text cursor-pointer"> <i class="icon-base ri ri-eye-off-line icon-20px"></i>
              </span>
            </div>
          </div>
          ...
          <div class="input-group input-group-merge">
            ...
            <div class="form-floating form-floating-outline">
              <input type="text" class="form-control" placeholder="id" id="basic-url14"
      ...
      <div class="card">
        ...
        <div class="card-body demo-vertical-spacing demo-only-element">
          ...
          <div class="input-group input-group-floating">
            <span class="input-group-text">https://example.com/users/</span>
            <div class="form-floating">
              <input type="text" class="form-control" id="basic-url24" placeholder="id"
          ...
          <div class="input-group input-group-floating">
            <span class="input-group-text">$</span>
            <div class="form-floating">
              <input type="number" class="form-control" placeholder="499"

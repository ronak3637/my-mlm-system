      ...
      <div class="card">
        ...
        <div class="card-body">
          <form class="browser-default-validation">
            ...
            <div class="form-floating form-floating-outline mb-6">
              <input type="text" class="form-control flatpickr-validation" placeholder="YYYY-MM-DD"
            ...
            <div class="form-floating form-floating-outline mb-6">
              <textarea class="form-control h-px-75" id="basic-default-bio" name="basic-default-bio" placeholder="My name is john"
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form class="needs-validation" novalidate>
            ...
            <div class="form-floating form-floating-outline mb-6">
              <textarea class="form-control h-px-75" id="bs-validation-bio" name="bs-validation-bio" rows="3"
                placeholder="My name is john" required></textarea>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form id="formValidationExamples" class="row g-5">
            ...
            <div class="col-md-6 form-control-validation">
              <div class="form-floating form-floating-outline">
                <input type="date" class="form-control flatpickr-validation" name="formValidationDob"
                  id="formValidationDob" placeholder="YYYY-MM-DD" required />
            ...
            <div class="col-md-6 form-control-validation">
              <div class="form-floating form-floating-outline">
                <input type="text" value="" class="form-control" name="formValidationLang"
                  id="formValidationLang" placeholder="React" />
                <label for="formValidationLang">Languages</label>
              </div>
            </div>
            <div class="col-md-6 form-control-validation">
              <div class="form-floating form-floating-outline">
                <select class="selectpicker tech-select w-100" id="formValidationTech" data-style="btn-default"
                  data-tick-icon="icon-base ri ri-check-line icon-sm text-white" name="formValidationTech" multiple>
            ...
            <div class="col-md-6 form-control-validation">
              <div class="form-floating form-floating-outline">
                <select class="selectpicker hobbies-select w-100" id="formValidationHobbies" data-style="btn-default"
                  data-tick-icon="icon-base ri ri-check-line icon-sm text-white" name="formValidationHobbies" multiple>
            ...
            <div class="col-md-6 form-control-validation">
              <div class="form-floating form-floating-outline">
                <textarea class="form-control h-px-100" id="formValidationBio" name="formValidationBio"
                  placeholder="My name is john" rows="3"></textarea>

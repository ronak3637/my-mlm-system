...
<section class="section-py first-section-pt">
  <div class="container">
    ...
    <p class="text-center text-body-secondary px-sm-12 mb-2"><span>All plans include 40+ advanced tools and features to
    ...
    <div class="d-flex align-items-center justify-content-center flex-wrap gap-2 py-5 mb-0 mb-md-4">
      ...
      <div class="mt-n5 ms-n10 ml-2 mb-8 d-none d-sm-flex align-items-center gap-2">
        ...
        <span class="badge badge-sm bg-label-primary rounded-pill mb-2 px-2">Save up to 10%</span>
      </div>
    </div>
        ...
        <div class="card border-primary border shadow-none">
          <div class="card-body position-relative pt-4">
            ...
            <div class="text-center">
              ...
              <small class="price-yearly price-yearly-toggle text-body-secondary">USD 90 / year</small>
            </div>
        ...
        <div class="card border rounded shadow-none">
          <div class="card-body pt-12">
            ...
            <div class="text-center">
              ...
              <small class="price-yearly price-yearly-toggle text-body-secondary">USD 190 / year</small>
            </div>
  ...
  <div class="container">
    <div class="position-relative">
      <div class="d-flex justify-content-between flex-column-reverse flex-lg-row align-items-center py-12">
        ...
        <!-- image -->
        <div class="text-center">
          <img src="{{asset('assets/img/illustrations/pricing-illustration.png')}}" alt="Pricing Illustration Image"
            width="202" />
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div id="faq" class="accordion">
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
            data-bs-target="#accordionPayment-2" aria-controls="accordionPayment-2">How do I pay for my order?</button>
        </h2>
        <div id="accordionPayment-2" class="accordion-collapse collapse">
          <div class="accordion-body">We accept Visa®, MasterCard®, American Express®, and PayPal®. Our servers encrypt
            all information submitted to them, so you can be confident that your credit card information will be kept
            safe and secure.</div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
            data-bs-target="#accordionPayment-4" aria-controls="accordionPayment-4">Which license do I need for an end
            product that is only accessible to paying users?</button>
        </h2>
        <div id="accordionPayment-4" class="accordion-collapse collapse">
          <div class="accordion-body">If you have paying users or you are developing any SaaS products then you need an
            Extended License. For each products, you need a license. You can get free lifetime updates as well.</div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
            data-bs-target="#accordionPayment-5" aria-controls="accordionPayment-5">Does my subscription automatically
            renew?</button>
        </h2>
        <div id="accordionPayment-5" class="accordion-collapse collapse">
          <div class="accordion-body">No, This is not subscription based item.Pastry pudding cookie toffee bonbon
            jujubes jujubes powder topping. Jelly beans gummi bears sweet roll bonbon muffin liquorice. Wafer lollipop
            sesame snaps.</div>
        </div>
      </div>
    </div>

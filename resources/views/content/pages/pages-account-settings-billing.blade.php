            ...
            <div class="col-md-6">
              ...
              <div class="plan-statistics">
                ...
                <div class="progress rounded bg-label-primary mb-1" style="height: 6px">
                  <div class="progress-bar w-75 rounded" role="progressbar" aria-valuenow="75" aria-valuemin="0"
                  ...
                  <div class="input-group input-group-merge">
                    <div class="form-floating form-floating-outline">
                      <input id="paymentCard" name="paymentCard" class="form-control credit-card-mask" type="text"
                        placeholder="135632156548789" aria-describedby="paymentCard2" />
                ...
                <div class="col-6 col-lg-3">
                  <div class="input-group input-group-merge">
                    ...
                    <span class="input-group-text cursor-pointer" id="paymentCvv2"><i
                        class="icon-base ri ri-question-line text-body-secondary" data-bs-toggle="tooltip"

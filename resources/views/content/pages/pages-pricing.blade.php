  ...
  <div class="card">
    ...
    <div class="pb-sm-12 pb-2 rounded-top">
      <div class="container py-12">
        ...
        <p class="text-center mb-2">All plans include 40+ advanced tools and features to boost your product. Choose the
          ...
          <div class="col-lg mb-lg-0 mb-3">
            <div class="card border shadow-none">
              <div class="card-body pt-12">
                ...
                <a href="{{ url('auth/register-basic') }}" class="btn btn-outline-success d-grid w-100">Your Current
                  Plan</a>
              </div>
            </div>
          </div>

        ...
        <ul class="nav nav-pills flex-column flex-sm-row mb-6 row-gap-2">
          <li class="nav-item">
            <a class="nav-link" href="{{ url('pages/profile-user') }}"><i
                class="icon-base ri ri-user-3-line icon-sm me-2"></i>
              Profile</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('pages/profile-teams') }}"><i
                class="icon-base ri ri-team-line icon-sm me-2"></i>
              Teams</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);"><i class="icon-base ri ri-link-m icon-sm me-2"></i>
              Connections</a>
          </li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-body text-center">
          <div class="dropdown btn-pinned">
            <button type="button" class="btn dropdown-toggle hide-arrow p-4" data-bs-toggle="dropdown"
              aria-expanded="false"><i class="icon-base ri ri-more-2-line icon-22px text-body-secondary"></i></button>
          ...
          <div class="d-flex align-items-center justify-content-center">
            <a href="javascript:;" class="btn btn-primary d-flex align-items-center me-4"><i
                class="icon-base ri ri-user-follow-line icon-16px me-2"></i>Connected</a>
            <a href="javascript:;" class="btn btn-outline-secondary btn-icon"><i
                class="icon-base ri ri-mail-open-line icon-22px"></i></a>
          </div>
        </div>
      </div>
    </div>
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card">
        <div class="card-body text-center">
          ...
          <div class="d-flex align-items-center justify-content-center">
            <a href="javascript:;" class="btn btn-outline-primary d-flex align-items-center me-4"><i
                class="icon-base ri ri-user-add-line icon-16px me-2"></i>Connect</a>
            <a href="javascript:;" class="btn btn-outline-secondary btn-icon"><i
                class="icon-base ri ri-mail-open-line icon-22px"></i></a>
          </div>
        </div>

        ...
        <ul class="nav nav-pills flex-column flex-sm-row mb-6 row-gap-2">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ url('pages/profile-connections') }}"><i
                class="icon-base ri ri-link-m icon-sm me-2"></i>
              Connections</a>
          </li>
        </ul>
      </div>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base ri ri-wechat-line icon-24px me-1"></i>15</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body border-top">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base ri ri-wechat-line icon-24px me-2"></i> 236</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body border-top">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base ri ri-wechat-line icon-24px me-1"></i> 98</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body border-top">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base ri ri-wechat-line icon-24px me-1"></i> 120</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body border-top">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base ri ri-wechat-line icon-24px me-1"></i> 20</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body border-top">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-auto">
              <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i
                  class="icon-base ri ri-wechat-line icon-24px me-1"></i> 16</a>
            </div>
          </div>
        </div>
      </div>

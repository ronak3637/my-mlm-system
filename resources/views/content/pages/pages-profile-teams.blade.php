    ...
    <div class="col-md-12">
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-sm-row mb-6 row-gap-2">
          <li class="nav-item">
            <a class="nav-link" href="{{ url('pages/profile-user') }}"><i
              ...
              <ul class="list-inline mb-0 d-flex align-items-center">
                <li class="list-inline-item me-1">
                  <a href="javascript:void(0);"
                    class="d-flex align-self-center btn btn-text-secondary btn-icon rounded-pill"><i
                      class="icon-base ri ri-star-line icon-22px text-body-secondary"></i></a>
                </li>
              ...
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                ...
                <li class="avatar avatar-sm">
                  <span class="avatar-initial rounded-circle pull-up text-heading" data-bs-toggle="tooltip"
                    data-bs-placement="top" title="9 more">+9</span>
                </li>
              </ul>
            </div>
            <div class="ms-auto">
          ...
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                ...
                <li class="avatar avatar-sm">
                  <span class="avatar-initial rounded-circle pull-up text-heading" data-bs-toggle="tooltip"
                    data-bs-placement="top" title="14 more">+4</span>
                </li>
              </ul>
            </div>
            <div class="ms-auto">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p>A design or product team is more than just the people on it. A team includes the people, the roles they play.
          </p>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                ...
                <li class="avatar avatar-sm">
                  <span class="avatar-initial rounded-circle pull-up bg-lighter text-body" data-bs-toggle="tooltip"
                    data-bs-placement="top" title="19 more">+9</span>
                </li>
              </ul>
            </div>
            <div class="ms-auto">
          ...
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                ...
                <li class="avatar avatar-sm">
                  <span class="avatar-initial rounded-circle pull-up bg-lighter text-body" data-bs-toggle="tooltip"
                    data-bs-placement="top" title="14 more">+2</span>
                </li>
              </ul>
            </div>
            <div class="ms-auto">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p>Digital marketing refers to advertising delivered through digital channels such as search engines, websites…
          </p>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                ...
                <li class="avatar avatar-sm">
                  <span class="avatar-initial rounded-circle pull-up text-heading" data-bs-toggle="tooltip"
                    data-bs-placement="top" title="7 more">+7</span>
                </li>
              </ul>
            </div>
            <div class="ms-auto">
              <a href="javascript:;" class="me-1"><span
                  class="badge bg-label-primary rounded-pill">Twitter</span></a>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p>Event is defined as a particular contest which is part of a program of contests. An example of an event is...
          </p>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                ...
                <li class="avatar avatar-sm">
                  <span class="avatar-initial rounded-circle pull-up text-heading" data-bs-toggle="tooltip"
                    data-bs-placement="top" title="2 more">+2</span>
                </li>
              </ul>
            </div>
            <div class="ms-auto">
    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <p>Explore, install, use, and remix thousands of plugins and files published to the Figma Community by
            designers.</p>
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center">
              <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                ...
                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Michel Pal"
                  class="avatar avatar-sm pull-up">
                  <img class="rounded-circle" src="{{ asset('assets/img/avatars/16.png') }}" alt="Avatar" />
                </li>
                <li class="avatar avatar-sm">
                  <span class="avatar-initial rounded-circle pull-up bg-lighter text-body" data-bs-toggle="tooltip"
                    data-bs-placement="top" title="22 more">+3</span>
                </li>
              </ul>
            </div>
            <div class="ms-auto">

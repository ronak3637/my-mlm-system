          ...
          <div class="col-lg-4 p-6 pt-0">
            ...
            <div class="demo-inline-spacing">
              <button type="button" class="btn btn-primary"><span
                  class="icon-base ri ri-check-double-line icon-16px me-2"></span>Primary</button>
              <button type="button" class="btn btn-secondary"><span
                  class="icon-base ri ri-notification-4-line icon-16px me-2"></span>Secondary</button>
            </div>
            <div class="demo-inline-spacing">
      ...
      <div class="card">
        ...
        <div class="row row-bordered g-0">
          <div class="col-lg-6 p-6">
            ...
            <div class="demo-inline-spacing">
              <button type="button" class="btn btn-primary btn-fab demo"><span
                  class="icon-base ri ri-check-double-line icon-16px me-2"></span>Primary</button>
              <button type="button" class="btn btn-secondary btn-fab demo"><span
                  class="icon-base ri ri-notification-4-line icon-16px me-2"></span>Secondary</button>
            </div>
            <div class="demo-inline-spacing">
              <button type="button" class="btn rounded-pill btn-primary btn-fab demo"><span
                  class="icon-base ri ri-check-double-line icon-16px me-2"></span>Primary</button>
              <button type="button" class="btn rounded-pill btn-secondary btn-fab demo"><span
                  class="icon-base ri ri-notification-4-line icon-16px me-2"></span>Secondary</button>
            </div>
          </div>
          <div class="col-lg-6 p-6">
            ...
            <div class="demo-inline-spacing">
              <button type="button" class="btn btn-label-primary btn-fab demo"><span
                  class="icon-base ri ri-check-double-line icon-16px me-2"></span>Primary</button>
              <button type="button" class="btn btn-label-secondary btn-fab demo"><span
                  class="icon-base ri ri-notification-4-line icon-16px me-2"></span>Secondary</button>
            </div>
            <div class="demo-inline-spacing">
              <button type="button" class="btn rounded-pill btn-label-primary btn-fab demo"><span
                  class="icon-base ri ri-check-double-line icon-16px me-2"></span>Primary</button>
              <button type="button" class="btn rounded-pill btn-label-secondary btn-fab demo"><span
                  class="icon-base ri ri-notification-4-line icon-16px me-2"></span>Secondary</button>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-4 p-6 pt-0">
            ...
            <div class="demo-inline-spacing">
              <button type="button" class="btn btn-facebook"><i
                  class="icon-base ri ri-facebook-circle-fill icon-16px me-2"></i>Facebook</button>
              <button type="button" class="btn btn-twitter"><i
                  class="icon-base ri ri-twitter-fill icon-16px me-2"></i>Twitter</button>
            </div>
            <div class="demo-inline-spacing">
              <button type="button" class="btn rounded-pill btn-google-plus"><i
                  class="icon-base ri ri-google-fill icon-16px me-2"></i>Google+</button>
              <button type="button" class="btn rounded-pill btn-instagram"><i
                  class="icon-base ri ri-instagram-line icon-16px me-2"></i>Instagram</button>
            </div>
          </div>
          <div class="col-lg-4 p-6 pt-0">
            <small class="fw-medium">Label(Tonal)</small>
            <div class="demo-inline-spacing">
              <button type="button" class="btn btn-label-linkedin"><i
                  class="icon-base ri ri-linkedin-box-fill icon-16px me-2"></i>Linkedin</button>
              <button type="button" class="btn btn-label-github"><i
                  class="icon-base ri ri-github-fill icon-16px me-2"></i>Github</button>
            </div>
            <div class="demo-inline-spacing">
              <button type="button" class="btn rounded-pill btn-label-pinterest"><i
                  class="icon-base ri ri-pinterest-fill icon-16px me-2"></i>Pinterest</button>
              <button type="button" class="btn rounded-pill btn-label-slack"><i
                  class="icon-base ri ri-slack-line icon-16px me-2"></i>Slack</button>
            </div>
          </div>
          <div class="col-lg-4 p-6 pt-0">
            ...
            <div class="demo-inline-spacing">
              <button type="button" class="btn btn-outline-dribbble"><i
                  class="icon-base ri ri-dribbble-line icon-16px me-2"></i>Dribbble</button>
              <button type="button" class="btn btn-text-reddit"><i
                  class="icon-base ri ri-reddit-fill icon-16px me-2"></i>Reddit</button>
            </div>
            <div class="demo-inline-spacing">
              <button type="button" class="btn rounded-pill btn-outline-youtube"><i
                  class="icon-base ri ri-youtube-fill icon-16px me-2"></i>Youtube</button>
              <button type="button" class="btn rounded-pill btn-text-vimeo"><i
                  class="icon-base ri ri-vimeo-fill icon-16px me-2"></i>Vimeo</button>
            </div>
          </div>
        </div>
        <hr class="m-0" />
          ...
          <div class="col-lg-4 p-6">
            ...
            <div class="demo-inline-spacing">
              <button type="button" class="btn btn-icon btn-facebook"><i
                  class="icon-base ri ri-facebook-circle-fill icon-22px"></i></button>
              <button type="button" class="btn btn-icon btn-twitter"><i
                  class="icon-base ri ri-twitter-fill icon-22px"></i></button>
          ...
          <div class="col-lg-4 p-6">
            ...
            <div class="demo-inline-spacing">
              <button type="button" class="btn btn-icon btn-label-linkedin"><i
                  class="icon-base ri ri-linkedin-box-fill icon-22px"></i></button>
              <button type="button" class="btn btn-icon btn-label-github"><i
                  class="icon-base ri ri-github-fill icon-22px"></i></button>
          ...
          <div class="col-lg-4 p-6">
            ...
            <div class="demo-inline-spacing">
              ...
              <button type="button" class="btn btn-icon btn-text-reddit"><i
                  class="icon-base ri ri-reddit-fill icon-22px"></i></button>
            ...
            <div class="demo-vertical-spacing">
              ...
              <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                ...
                <label class="btn btn-outline-primary" for="btncheck1">
                  <span class="d-block d-sm-none"><i class="icon-base ri ri-home-4-line icon-20px"></i></span>
                  <span class="d-none d-sm-block"> Checkbox 1(pre-checked)</span>
                </label>

                <input type="checkbox" class="btn-check" id="btncheck2" />
                <label class="btn btn-outline-primary" for="btncheck2">
                  <span class="d-block d-sm-none"><i class="icon-base ri ri-flight-takeoff-line icon-20px"></i></span>
                  <span class="d-none d-sm-block">Checkbox 2</span>
                </label>

                <input type="checkbox" class="btn-check" id="btncheck3" />
                <label class="btn btn-outline-primary" for="btncheck3">
                  <span class="d-block d-sm-none"><i class="icon-base ri ri-notification-4-line icon-20px"></i></span>
              ...
              <div class="btn-toolbar demo-inline-spacing gap-2" role="toolbar"
                ...
                <div class="btn-group" role="group" aria-label="First group">
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-notification-4-line"></i></button>
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-calendar-line"></i></button>
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-shield-check-line"></i></button>
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-message-2-line"></i></button>
                </div>
                <div class="btn-group" role="group" aria-label="Second group">
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-bold"></i></button>
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-italic"></i></button>
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-underline"></i></button>
                </div>
                <div class="btn-group" role="group" aria-label="Third group">
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-volume-up-line"></i></button>
                </div>
              </div>
            </div>
            <div class="col-xl-6">
              ...
              <div class="mt-4">
                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-car-line"></i></button>
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-rocket-2-line"></i></button>
                  <button type="button" class="btn btn-outline-secondary"><i
                      class="icon-base ri ri-lightbulb-line"></i></button>
                  <div class="btn-group" role="group">
                    <button id="btnGroupDrop1" type="button" class="btn btn-outline-secondary dropdown-toggle"
                      data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                        class="icon-base ri ri-more-2-line icon-20px"></i><span

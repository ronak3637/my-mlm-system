        ...
        <div class="dropdown dropup footer-link me-4">
          ...
          <div class="dropdown-menu dropdown-menu-end">
            <a class="dropdown-item" href="javascript:void(0);"><i
                class="icon-base ri ri-money-dollar-circle-line icon-sm me-2"></i>USD</a>
            <a class="dropdown-item" href="javascript:void(0);"><i
                class="icon-base ri ri-money-euro-circle-line icon-sm me-2"></i>Euro</a>
            <a class="dropdown-item" href="javascript:void(0);"><i
                class="icon-base ri ri-money-pound-circle-line icon-sm me-2"></i>Pound</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="javascript:void(0);"><i
                class="icon-base ri ri-btc-line icon-sm me-2"></i>Bitcoin</a>
          </div>
        </div>
        <a href="javascript:void(0)" class="btn btn-sm btn-outline-danger"><i
            class="icon-base ri ri-logout-box-r-line icon-sm me-1"></i>Logout</a>
      </div>
    </div>
  </footer>
</section>
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-3 mb-6 mb-sm-0">
          <h4 class="fw-bold mb-4"><a href="{{ config('variables.livePreview') }}" target="_blank"
              class="footer-brand">{{config('variables.templateName')}}
            </a></h4>
          ...
          <div class="social-icon my-4 d-flex flex-sm-row">
            <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-facebook me-2"><i
                class="icon-base ri ri-facebook-circle-fill icon-22px"></i></a>
            <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-twitter me-2"><i
                class="icon-base ri ri-twitter-fill icon-22px"></i></a>
            <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-linkedin me-2"><i
                class="icon-base ri ri-linkedin-box-fill icon-22px"></i></a>
            <a href="javascript:void(0)" class="btn btn-icon btn-sm btn-github"><i
                class="icon-base ri ri-github-fill icon-22px"></i></a>
          </div>
          <p class="pt-6">
            <script>

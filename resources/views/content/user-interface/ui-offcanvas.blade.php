              ...
              <div class="mt-4">
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasStart"
                  ...
                  <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                    <p class="text-center">Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying
                      out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th
        ...
        <div class="card-body">
          <div class="row gy-3">
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="mt-4">
                <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
                  data-bs-target="#offcanvasScroll" aria-controls="offcanvasScroll">Enable Body Scrolling</button>
        ...
        <div class="card-body">
          ...
          <div>
            <button class="btn btn-primary d-xl-none" type="button" data-bs-toggle="offcanvas"
              data-bs-target="#offcanvasResponsive" aria-controls="offcanvasResponsive">Toggle offcanvas-xl</button>
            <div class="alert alert-info d-xl-block d-none mt-4">Resize your browser to <code>xl</code> breakpoint to
              show the responsive offcanvas toggle.</div>

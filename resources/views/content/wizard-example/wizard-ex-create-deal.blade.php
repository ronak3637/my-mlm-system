    ...
    <div class="bs-stepper-content">
      <form id="wizard-create-deal-form" onSubmit="return false">
        ...
        <div id="deal-type" class="content">
          <div class="row g-6">
            <div class="col-12">
              <img class="img-fluid border rounded-3" src="{{ asset('assets/img/illustrations/shopping-girl.png') }}"
                alt="Shopping Girl" />
            </div>
            <div class="col-12">
              <div class="row g-5">
        ...
        <div id="deal-details" class="content">
          <div class="row g-4">
            ...
            <div class="col-sm-6">
              <div class="form-floating form-floating-outline">
                <textarea id="dealDescription" name="dealDescription" class="form-control" style="height: 122px;"
          ...
          <div class="row g-3">
            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center border rounded-3 pt-3">
              <img class="img-fluid scaleX-n1-rtl"
                src="{{ asset('assets/img/illustrations/create-deal-review-complete.png') }}" alt="process completed"
                width="170" />
            </div>

      ...
      <form id="wizard-property-listing-form" onSubmit="return false">
        ...
        <div id="property-details" class="content">
          <div class="row g-5">
            ...
            <div class="col-lg-12 form-control-validation">
              <div class="form-floating form-floating-outline">
                <textarea id="plAddress" name="plAddress" class="form-control" style="height: 144px;"
        ...
        <div id="property-features" class="content">
          <div class="row g-5">
            ...
            <div class="col-lg-12">
              <div class="form-floating form-floating-outline">
                <input id="plFurnishingDetails" name="plFurnishingDetails" class="form-control h-auto"
          ...
          <div class="row g-5">
            <div class="col-sm-6">
              <div class="input-group input-group-merge">
                ...
                <span class="input-group-text" id="pl-expeacted-price"><i
                    class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i></span>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="input-group input-group-merge">
                ...
                <span class="input-group-text" id="pl-price-sqft"><i
                    class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i></span>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="input-group input-group-merge">
                ...
                <span class="input-group-text" id="pl-mentenence-charge"><i
                    class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i></span>
              </div>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <div class="input-group input-group-merge">
                ...
                <span class="input-group-text" id="pl-booking-amount"><i
                    class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i></span>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="input-group input-group-merge">
                ...
                <span class="input-group-text" id="pl-other-amount"><i
                    class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i></span>
              </div>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-12 d-flex justify-content-between mt-6">
              ...
              <button class="btn btn-success btn-submit btn-next"><span
                  class="align-middle d-sm-inline-block d-none">Submit</span> <i
